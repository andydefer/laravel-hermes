...
final class SuggestionResultRecordCollectionTest extends IntegrationTestCase
{
    private SuggestionResultRecordCollection $collection;

    protected function setUp(): void
    {
        parent::setUp();

        $this->collection = new SuggestionResultRecordCollection;
    }
    ...
    private function createTestRecord(
        ...
        return new SuggestionResultRecord(
            token_id: $tokenId,
    ...
    public function test_can_group_by_document(): void
    {
        ...
        $this->assertInstanceOf(SuggestionResultRecordCollection::class, $groups['doc_1']);
    }
    ...
    public function test_can_group_by_field(): void
    {
        ...
        $this->assertInstanceOf(SuggestionResultRecordCollection::class, $groups['name']);
    }
    ...
    public function test_get_ids_returns_empty_array_when_empty(): void
    {
        $ids = $this->collection->getIds();
    ...
    {
        $original = new SuggestionResultRecordCollection;
    ...
    public function test_filter_returns_same_type(): void
    {
        ...
        $this->assertInstanceOf(SuggestionResultRecordCollection::class, $filtered);
    }
